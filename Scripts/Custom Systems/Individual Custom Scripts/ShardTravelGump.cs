    ...
    public class ShardTravelMap : Item
    {
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (count > 0)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    try
                    {
                        m_Entries.Add(new ShardTravelEntry(0, reader.ReadInt(), reader.ReadString(), reader.ReadPoint3D(),
        ...
        public List<ShardTravelEntry> GetDefaultEntries()
        {
            ...
            catch (Exception e)
            {
                ...
                entries = new List<ShardTravelEntry>();

                // Trammel Cities			
                entries.Add(new ShardTravelEntry(100, 1, "Britain", new Point3D(1434, 1699, 2), Map.Trammel, 171, 172, 147, 176));
                entries.Add(new ShardTravelEntry(101, 0, "Bucs Den", new Point3D(2705, 2162, 0), Map.Trammel, 0, 0, 0, 0));
                entries.Add(new ShardTravelEntry(102, 0, "Cove", new Point3D(2237, 1214, 0), Map.Trammel, 0, 0, 0, 0));
                entries.Add(new ShardTravelEntry(103, 1, "New Haven", new Point3D(3493, 2577, 14), Map.Trammel, 314, 248, 314, 268));
                entries.Add(new ShardTravelEntry(104, 1, "Jhelom", new Point3D(1417, 3821, 0), Map.Trammel, 146, 369, 141, 191));
                entries.Add(new ShardTravelEntry(105, 0, "Magincia", new Point3D(3728, 2164, 20), Map.Trammel, 0, 0, 0, 0));
                ...
                entries.Add(new ShardTravelEntry(108, 0, "Nujel'm", new Point3D(3770, 1308, 0), Map.Trammel, 0, 0, 0, 0));
                entries.Add(new ShardTravelEntry(109, 1, "Serpents Hold", new Point3D(2895, 3479, 15), Map.Trammel, 0, 0, 0, 0));
                ...
                // Trammel Dungeons			
                entries.Add(new ShardTravelEntry(200, 0, "Covetous", new Point3D(2498, 921, 0), Map.Trammel, 0, 0, 0, 0));
                ...
                // Felucca Cities			
                entries.Add(new ShardTravelEntry(300, 2, "Britain", new Point3D(1434, 1699, 2), Map.Felucca, 171, 172, 147, 176));
                entries.Add(new ShardTravelEntry(301, 0, "Bucs Den", new Point3D(2705, 2162, 0), Map.Felucca, 0, 0, 0, 0));
                entries.Add(new ShardTravelEntry(302, 0, "Cove", new Point3D(2237, 1214, 0), Map.Felucca, 0, 0, 0, 0));
                entries.Add(new ShardTravelEntry(303, 2, "Jhelom", new Point3D(1417, 3821, 0), Map.Felucca, 146, 369, 141, 191));
                entries.Add(new ShardTravelEntry(304, 0, "Magincia", new Point3D(3728, 2164, 20), Map.Felucca, 0, 0, 0, 0));
                entries.Add(new ShardTravelEntry(305, 2, "Minoc", new Point3D(2525, 582, 0), Map.Felucca, 232, 50, 232, 70));
                entries.Add(new ShardTravelEntry(306, 2, "Moonglow", new Point3D(4471, 1177, 0), Map.Felucca, 312, 117, 364, 130));
                entries.Add(new ShardTravelEntry(307, 0, "Nujel'm", new Point3D(3770, 1308, 0), Map.Felucca, 0, 0, 0, 0));
                entries.Add(new ShardTravelEntry(308, 0, "Ocllo", new Point3D(3626, 2611, 0), Map.Felucca, 0, 0, 0, 0));
                entries.Add(new ShardTravelEntry(309, 0, "Serpents Hold", new Point3D(2895, 3479, 15), Map.Felucca, 0, 0, 0, 0));
                entries.Add(new ShardTravelEntry(310, 2, "Skara Brae", new Point3D(596, 2138, 0), Map.Felucca, 45, 246, 78, 228));
                entries.Add(new ShardTravelEntry(311, 2, "Trinsic", new Point3D(1823, 2821, 0), Map.Felucca, 182, 260, 182, 280));
                entries.Add(new ShardTravelEntry(312, 2, "Vesper", new Point3D(2899, 676, 0), Map.Felucca, 247, 104, 247, 124));
                entries.Add(new ShardTravelEntry(313, 2, "Yew", new Point3D(542, 985, 0), Map.Felucca, 62, 81, 78, 104));

                // Felucca Dungeons			
                entries.Add(new ShardTravelEntry(400, 0, "Covetous", new Point3D(2498, 921, 0), Map.Felucca, 0, 0, 0, 0));
                ...
                // Ilshenar Cities			
                entries.Add(new ShardTravelEntry(700, 3, "Gargoyle City", new Point3D(852, 602, -40), Map.Ilshenar, 160, 120, 160, 140));
                entries.Add(new ShardTravelEntry(701, 3, "Lakeshire", new Point3D(1203, 1124, -25), Map.Ilshenar, 280, 300, 280, 320));
                entries.Add(new ShardTravelEntry(702, 3, "Mistas", new Point3D(819, 1130, -29), Map.Ilshenar, 160, 280, 160, 300));
                entries.Add(new ShardTravelEntry(703, 3, "Montor", new Point3D(1706, 205, 104), Map.Ilshenar, 350, 20, 350, 40));
                ...
                // Malas Cities			
                entries.Add(new ShardTravelEntry(1000, 4, "Luna", new Point3D(1015, 527, -65), Map.Malas, 60, 90, 60, 110));
                entries.Add(new ShardTravelEntry(1001, 4, "Umbra", new Point3D(1997, 1386, -85), Map.Malas, 290, 260, 290, 280));
